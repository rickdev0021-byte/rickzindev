			...
			<div class="grid grid-cols-1 md:grid-cols-4 gap-8">
				...
				<div class="md:col-span-2">
					...
					<p class="text-slate-400 text-sm max-w-md">
						Fullstack Developer especializado em tecnologias modernas. 
						Criando soluções inovadoras com SvelteKit, Supabase e TypeScript.
					</p>
				</div>
				...
				<div>
					...
					<ul class="space-y-2">
						<li><a href="/" class="text-slate-400 hover:text-accent-primary text-sm">Início</a></li>
						<li><a href="/projetos" class="text-slate-400 hover:text-accent-primary text-sm">Projetos</a></li>
						<li><a href="/contato" class="text-slate-400 hover:text-accent-primary text-sm">Contato</a></li>
						<li><a href="/api-docs" class="text-slate-400 hover:text-accent-primary text-sm">API Docs</a></li>
					</ul>
				</div>
				...
				<div>
					...
					<div class="flex gap-4">
						...
						<a href="https://linkedin.com" target="_blank" rel="noopener" aria-label="LinkedIn" class="text-slate-400 hover:text-white transition-colors">
							<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
